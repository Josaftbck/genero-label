...
public class Docente extends Persona {
    ...
    public Docente(Integer id, String nit, String nombres, String apellidos, String direccion, String telefono, String fecha_nacimiento, String codigo_docentes, Double salario, String fecha_ingreso_laborar, String fecha_ingreso_registro, Boolean Genero) {
   ...
   public DefaultTableModel leer() {
        ...
        try {
            ...
            String encabezado[] = {"Id_docente", "Codigo_docente", "Nombres", "Apellidos", "Direccion", "Telefono", "Nacimiento", "nit", "Salario", "Fecha ingreso laborar", "Fecha ingreso registro", "Genero"};
            ...
            while (consulta.next()) {
                ...
                datos[11] = consulta.getBoolean("genero") ? "Hombre" : "Mujer"; // Mostrar como texto
                tabla.addRow(datos);
            }
    ...
    public void agregar() {
        try {
            ...
            cn = new Conexion();
            cn.abrir_conexion();
            String query = "INSERT INTO docente (id_docente, codigo_docente, nombres, apellidos, direccion, telefono, fecha_nacimiento, nit, salario, fecha_ingreso_laborar, fecha_ingreso_registro, genero) " +
                           "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
            ...
            parametro.setBoolean(12, this.getGenero()); // Guardar como booleano (true o false)
    ...
    public void actualizar() {
        try {
            ...
            String query = "UPDATE docente SET nit = ?, nombres = ?, apellidos = ?, direccion = ?, telefono = ?, fecha_nacimiento = ?, " +
                           "codigo_docente = ?, salario = ?, fecha_ingreso_laborar = ?, fecha_ingreso_registro = ?, genero = ? WHERE id_docente = ?;";
            parametro = (PreparedStatement) cn.conexionBD.prepareStatement(query);
            ...
            parametro.setBoolean(11, getGenero()); // Actualizar género
            parametro.setInt(12, getId());
